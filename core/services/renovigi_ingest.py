...
try:
    from core.services.renovigi_client import RenovigiClient, RenovigiError  # type: ignore
except Exception:  # pragma: no cover
    from core.services.renovigi_client import RenovigiClient  # type: ignore
